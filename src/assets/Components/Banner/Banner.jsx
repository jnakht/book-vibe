...
const Banner = () => {
    return (
            <div className="bg-[url('./banner.png')] h-[200px] md:h-[600px] w-full rounded-3xl bg-cover bg-[85%_center]  bg-no-repeat banner pl-5 pt-[10%] pb-[10%] md:pb-0 md:p-[120px] bg-[#1313130D] mt-[30px] md:mt-[52px] mb-[100px]">
